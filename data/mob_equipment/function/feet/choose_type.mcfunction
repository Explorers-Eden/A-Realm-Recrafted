...
execute if score $eden.feet.type eden.technical matches 1..30 run data modify entity @s ArmorDropChances[0] set value 0.025F
execute if score $eden.feet.type eden.technical matches 31..40 run data modify entity @s ArmorDropChances[0] set value 0.020F
execute if score $eden.feet.type eden.technical matches 41..50 run data modify entity @s ArmorDropChances[0] set value 0.015F
execute if score $eden.feet.type eden.technical matches 51..60 run data modify entity @s ArmorDropChances[0] set value 0.010F
execute if score $eden.feet.type eden.technical matches 61..67 run data modify entity @s ArmorDropChances[0] set value -327.670F