...
execute as @e[type=item,tag=realmrecrafted.spawn.conveyor_item] at @s if block ~ ~ ~ minecraft:polished_blackstone_pressure_plate run particle minecraft:poof ~ ~ ~ 0.1 0.1 0.1 0.01 3
