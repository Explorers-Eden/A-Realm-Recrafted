...
from scripts.utils import clean, write_yaml, map_booleans, deep_format
...
RENAME = {
    ...
    "protectAgainstHostileExplosionsActivatedByTrustedPlayers": "Protect Against Hostile Explosions Triggered By Trusted Players",
